...
import { ToolConfiguration } from "../core/entities/plugin/declaration/tool.js";
import { ToolProviderConfiguration } from "../core/entities/plugin/provider.js";
import { ModelProviderConfiguration } from "../core/entities/plugin/declaration/model.js";
import { EndpointConfiguration, EndpointProviderConfiguration } from "../core/entities/plugin/declaration/endpoint.js";
import { AgentStrategyProviderConfiguration } from "../core/entities/plugin/agent.js";
import { AnyConstructor, ClassInfo, ModuleClassScanner } from "../core/classes/module-loader.js";
import { TOOL_PROVIDER_SYMBOL, ToolProvider } from "../interfaces/tool/tool-provider.js";
...
import { TTS_MODEL_SYMBOL } from "../interfaces/model/tts.model.js";
import { SPEECH2TEXT_MODEL_SYMBOL } from "../interfaces/model/speech2text.model.js";
import { MODERATION_MODEL_SYMBOL } from "../interfaces/model/moderation.model.js";
import { ENDPOINT_SYMBOL, EndpointClassType, isEndpointClass } from "../interfaces/endpoint/endpoint.js";
import { AGENT_STATEGY_SYMBOL, AgentStrategyClassType, isAgentStrategyClass } from "../interfaces/agent/agent-strategy.js";
import { PluginAsset } from "../core/entities/event/asset.js";
import { PluginDeclaration } from "../core/entities/plugin/declaration/declaration.js";
import { MODEL_PROVIDER_SYMBOL, ModelProvider } from "../interfaces/model/model-provider.js";
