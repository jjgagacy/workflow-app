import { BlobInvokeMessage, InvokeMessage, InvokeMessageMeta, JsonInvokeMessage, RetrieverResourceInvokeMessage, TextInvokeMessage, VariableInvokeMessage } from "@/core/dtos/invoke-message.dto";
