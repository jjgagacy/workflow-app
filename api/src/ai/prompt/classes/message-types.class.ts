import { ImageDetail } from "@/service/libs/file/file.type";
...
export abstract class MultiModalPromptMessageContent extends PromptMessageContent {
  format!: string;
  base64_data: string = '';
  url = '';
  mime_type!: string;
...
export class ImagePromptMessageContent extends MultiModalPromptMessageContent {
  type: PromptMessageContentType.IMAGE = PromptMessageContentType.IMAGE;

  detail: ImageDetail = ImageDetail.LOW;
}

export class DocumentPromptMessageContent extends MultiModalPromptMessageContent {
