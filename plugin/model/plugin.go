...
type Plugin struct {
	...
	InstallType            plugin_entities.PluginRuntimeType `gorm:"size:127;index" json:"install_type"`
	ManifestType           manifest_entites.ManifestType     `gorm:"size:127" json:"manifest_type"`
	RemoteDeclaration      plugin_entities.PluginDeclaration `gorm:"serializer:json;type:text;size:65535"`
}
...
type PluginDeclaration struct {
	...
	Declaration            plugin_entities.PluginDeclaration `gorm:"serializer:json;type:text;size:65535" json:"declaration"`
}
