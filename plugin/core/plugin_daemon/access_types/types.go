...
func (p PluginAccessType) IsValid() bool {
	...
	case
		...
		PLUGIN_ACCESS_TYPE_ENDPOINT,
		PLUGIN_ACCESS_TYPE_AGENT_STRATEGY,
		PLUGIN_ACCESS_TYPE_OAUTH,
		PLUGIN_ACCESS_TYPE_DYNAMIC_PARAMETER:
		return true
	default:
		return false
	}
...
func (p PluginAccessAction) IsValid() bool {
	...
	case
		...
		PLUGIN_ACCESS_ACTION_GET_TOOL_RUNTIME_PARAMETERS,
		...
		PLUGIN_ACCESS_ACTION_GET_TTS_MODEL_VOICES,
		PLUGIN_ACCESS_ACTION_GET_TEXT_EMBEDDING_NUM_TOKENS,
		PLUGIN_ACCESS_ACTION_GET_AI_MODEL_SCHEMAS,
		PLUGIN_ACCESS_ACTION_GET_LLM_NUM_TOKENS,
		PLUGIN_ACCESS_ACTION_INVOKE_AGENT_STRATEGY,
		PLUGIN_ACCESS_ACTION_GET_AUTHORIZATION_URL,
		PLUGIN_ACCESS_ACTION_GET_CREDENTIALS,
		PLUGIN_ACCESS_ACTION_REFRESH_CREDENTIALS,
		PLUGIN_ACCESS_ACTION_DYNAMIC_PARAMETER_FETCH_OPTIONS:
		return true
	default:
		return false
	}
