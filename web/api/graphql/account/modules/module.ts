...
export const useCreateModule = () => {
  const mutation = useGraphQLMutation<{ createModule: any }, {
    input: {
      key: string;
      name: string;
    }
...
export const useUpdateModule = () => {
  const mutation = useGraphQLMutation<{ updateModule: any }, {
    input: {
      id: number;
      key: string;
      name: string;
...
export const useCreateModulePerm = () => {
  const mutation = useGraphQLMutation<{ createPerm: any }, {
    input: {
      module: string;
      key: string;
      name: string;
...
export const useUpdateModulePerm = () => {
  const mutation = useGraphQLMutation<{ updatePerm: any }, {
    input: {
      module: string;
      key: string;
      name: string;
...
export const useDeleteModulePerm = () => {
  const mutation = useGraphQLMutation<{ deletePerm: any }, {
    input: {
      module: string;
      key: string;
    }
