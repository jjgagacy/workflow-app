interface NodeValidationErrorProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}

const NodeValidationError = ({ className, size = 24, ...props }: NodeValidationErrorProps) => {
