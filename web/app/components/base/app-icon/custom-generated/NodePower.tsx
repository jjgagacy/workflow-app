interface NodePowerProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}

const NodePower = ({ className, size = 24, ...props }: NodePowerProps) => {
