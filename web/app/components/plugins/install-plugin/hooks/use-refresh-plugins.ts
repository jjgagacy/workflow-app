...
export const useRefreshPlugins = () => {
  ...
  const { mutateModelProviderList, mutateModelsByModelType } = useModelProviderContext();

  return {
    refreshPlugins: async (plugin?: Plugin | null, refreshAll?: boolean) => {
