const translation = {
  ...
  nodes: {
    ...
    schedule: {
      name: '定时任务',
      description: '定时触发器',
      description2: '可按时、天、周、月快速设置，也可直接输入 Cron 规格来自动触发工作流。',
      mode: '模式',
      modeOptions: {
        hour: '按时',
        day: '按天',
  ...
  variablePanel: {
    environment: {
      title: '环境变量',
      description: '存储工作流中的敏感信息如API的Base URL、密钥等',
      empty: '暂无环境变量。',
      add: '添加变量',
      createDialogTitle: '添加环境变量',
      editDialogTitle: '编辑环境变量',
      dialogDescription: '设置此工作流变量的类型、名称、值和说明。',
    },
    session: {
      title: '会话变量',
      description: '',
      empty: '暂无会话变量。',
      add: '添加变量',
      createDialogTitle: '添加会话变量',
      editDialogTitle: '编辑会话变量',
      dialogDescription: '设置此会话变量的类型、名称、值和说明。',
    },
    count_one: '{{count}} 个变量已配置。',
    count_other: '{{count}} 个变量已配置。',
    type: '类型',
    name: '变量名',
    value: '值',
    description: '说明',
    descriptionPlaceholder: '可选说明',
    namePlaceholder: '例如：API_BASE_URL',
    valuePlaceholder: '请输入值',
    noDescription: '暂无说明',
    emptyState: '添加您的第一个变量，以便在此工作流中使用。',
    cancel: '取消',
    save: '保存',
    add: '添加',
    editAria: '编辑 {{name}}',
    ...
    deleteConfirm: {
      title: '删除 {{name}}?',
      defaultName: '此变量',
      message: '此操作无法撤销。该变量将从当前工作流中永久删除。',
    },
    types: {
      string: '字符串',
      number: '数字',
    ...
    validation: {
      ...
      namePattern: '变量名只能包含字母、数字和下划线，且必须以字母或下划线开头。',
      nameExists: '变量名已存在。',
      number: '数字变量必须为有效数字值。',
      boolean: '布尔变量必须为 true 或 false。',
      object: '对象变量必须是有效的 JSON 对象。',
    },
  },
  iteration: {
    parallel: '并行',
  ...
  checkList: {
    error: {
      ...
      parameterExtractorParameterNameMissing: '请为参数 {{index}} 填写名称。',
      parameterExtractorParameterDescriptionMissing: '请为参数 {{index}} 填写描述。',
      parameterExtractorOutputVariableMissing: '请填写输出变量名。',
      documentExtractorInputVariableMissing: '请选择文件输入变量。',
      documentExtractorOutputVariableMissing: '请填写输出变量名。',
      questionClassifierModelMissing: '请选择模型。',
      questionClassifierInputVariableMissing: '请选择要分类的输入变量。',
      questionClassifierCategoryMissing: '请至少添加一个分类。',
      questionClassifierCategoryNameMissing: '请为分类 {{index}} 填写名称。',
      questionClassifierCategoryPromptMissing: '请为分类 {{index}} 填写提示词。',
      knowledgeRetrievalInputVariableMissing: '请选择要检索的输入变量。',
      knowledgeRetrievalOutputVariableMissing: '请填写输出变量名。',
      knowledgeRetrievalKnowledgeBaseMissing: '请至少添加一个知识库。',
      listOperatorInputVariableMissing: '请选择数组输入变量。',
      listOperatorOutputVariableMissing: '请填写输出变量名。',
      filterConditionMissing: '请至少添加一个过滤条件。',
      filterVariableMissing: '请为条件 {{index}} 选择变量。',
      filterValueMissing: '请为条件 {{index}} 输入比较值。',
      variableAggregatorVariableMissing: '请至少添加一个要聚合的变量。',
      variableAggregatorVariableSelectorMissing: '请为第 {{index}} 项选择变量。',
      variableAggregatorDuplicateVariable: '第 {{index}} 项的变量已被选择过。',
      variableAggregatorOutputNameMissing: '请填写输出变量名。',
