...
const translation = {
  ...
  nodes: {
    ...
    start: {
      name: 'Start',
      description: 'Trigger manually, Starting point of the workflow'
    },
    if: {
      name: 'If',
    ...
    webhook: {
      ...
      path: 'Path',
      pathLoading: 'Generating path...',
      pathPlaceholder: 'Webhook path',
      pathReadonly: 'Path is generated by the server and cannot be edited manually.',
      urlConfig: 'Webhook URL',
      webhookUrl: 'Production URL',
      webhookTestUrl: 'Test URL',
      queryStrings: 'Query Strings',
      addQueryString: 'Add Query',
      deleteQueryString: 'Delete Query',
      headerParams: 'Header Params',
      addHeaderParam: 'Add Header',
      deleteHeaderParam: 'Delete Header',
      bodyParams: 'Body Params',
      addBodyParam: 'Add Body Param',
      deleteBodyParam: 'Delete Body Param',
      fieldName: 'Name',
      required: 'Required',
      queryStringPlaceholder: 'e.g.: traceId',
      headerParamPlaceholder: 'e.g.: Authorization',
      bodyParamPlaceholder: 'e.g.: orderId',
      successResponse: 'Success Response (Optional)',
    ...
    schedule: {
      ...
      description2: 'Choose a trigger mode or enter a full cron expression to run the workflow automatically.',
      mode: 'Mode',
      modeOptions: {
        hour: 'Hourly',
        day: 'Daily',
  ...
  startPanel: {
    ...
    variablesConfigured: '{{count}} variables configured',
    add: 'Add',
    required: 'required',
    default: 'default',
    empty: 'No variables yet. Click Add to create one.',
    addVariable: 'Add Variable',
    editVariable: 'Edit Variable',
    addVariableDescription: 'Configure common attributes and type-specific settings',
    typeLabel: 'Type',
    variableName: 'Variable name',
    variableNamePlaceholder: 'e.g. user_name',
    displayName: 'Display name',
    displayNamePlaceholder: 'Shown to end users',
    requiredLabel: 'Required',
    defaultValue: 'Default value',
    textareaDefaultPlaceholder: 'textarea default',
    textDefaultPlaceholder: 'text default',
    ...
    uploadSourceLocal: 'Local',
    uploadSourceUrl: 'URL',
    uploadSourceBoth: 'Local + URL',
    maxUploadCount: 'Max upload count',
    maxUploadCountPlaceholder: 'e.g. 5',
    type: {
    ...
    error: {
      ...
      optionLabelValueRequired: 'Option label and value are required.',
      maxLengthPositive: 'Max length must be a positive number.',
      maxUploadPositive: 'Max upload count must be greater than 0.',
    },
  },
  variablePanel: {
    environment: {
      title: 'Environment variables',
      description: 'Stores sensitive information in the workflow, such as the API Base URL, keys, etc.',
      empty: 'No environment variables yet.',
      add: 'Add variable',
      createDialogTitle: 'Add environment variable',
    ...
    session: {
      ...
      description: '',
      empty: 'No session variables yet.',
      add: 'Add variable',
      createDialogTitle: 'Add session variable',
      editDialogTitle: 'Edit session variable',
    ...
    namePlaceholder: 'e.g. API_BASE_URL',
    valuePlaceholder: 'Enter a value',
    noDescription: 'No description',
    emptyState: 'Add your first variable to use it in this workflow.',
    cancel: 'Cancel',
    save: 'Save',
    add: 'Add',
    editAria: 'Edit {{name}}',
    ...
    deleteConfirm: {
      title: 'Delete {{name}}?',
      defaultName: 'this variable',
      message: 'This action cannot be undone. The variable will be permanently removed from the workflow.',
    },
    types: {
      string: 'String',
      number: 'Number',
    ...
    validation: {
      ...
      namePattern: 'Variable name can only contain letters, numbers, and underscores, and must start with a letter or underscore.',
      nameExists: 'Variable name already exists.',
      number: 'Number variables must have a numeric value.',
      boolean: 'Boolean variables must be true or false.',
      object: 'Object variables must be a valid JSON object.',
    },
  },
  iteration: {
    parallel: 'Parallel',
  ...
  checkList: {
    error: {
      ...
      parameterExtractorParameterNameMissing: 'Please enter a name for parameter {{index}}.',
      parameterExtractorParameterDescriptionMissing: 'Please enter a description for parameter {{index}}.',
      parameterExtractorOutputVariableMissing: 'Please enter an output variable name.',
      documentExtractorInputVariableMissing: 'Please select a file input variable.',
      documentExtractorOutputVariableMissing: 'Please enter an output variable name.',
      questionClassifierModelMissing: 'Please select a model.',
      questionClassifierInputVariableMissing: 'Please select an input variable to classify.',
      questionClassifierCategoryMissing: 'Please add at least one category.',
      questionClassifierCategoryNameMissing: 'Please enter a name for category {{index}}.',
      questionClassifierCategoryPromptMissing: 'Please enter a prompt for category {{index}}.',
      knowledgeRetrievalInputVariableMissing: 'Please select an input variable to retrieve from.',
      knowledgeRetrievalOutputVariableMissing: 'Please enter an output variable name.',
      knowledgeRetrievalKnowledgeBaseMissing: 'Please add at least one knowledge base.',
      listOperatorInputVariableMissing: 'Please select an array input variable.',
      listOperatorOutputVariableMissing: 'Please enter an output variable name.',
      ...
      variableAggregatorVariableMissing: 'Please add at least one variable to aggregate.',
      variableAggregatorVariableSelectorMissing: 'Please select a variable for item {{index}}.',
      variableAggregatorDuplicateVariable: 'The variable in item {{index}} has already been selected.',
      variableAggregatorOutputNameMissing: 'Please enter an output variable name.',
